		...
		<form method="post" action="" class="validate">
			...
			<div id="post-body">
				...
				<div class="form-field">
						<label for="otw_cm_promotions"><?php _e('Show OTW Promotion Messages in my WordPress admin', 'otw_tsw'); ?></label>
				...
				<p class="submit">
					<input type="submit" value="<?php _e( 'Save Settings', 'otw_tsw') ?>" name="submit" class="button"/>
				</p>
			</div>
		</form>
	</div>
