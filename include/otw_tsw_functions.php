...
if( !function_exists( 'otw_tsw_init' ) ){
	...
	function otw_tsw_init(){
		...
		$otw_tsw_factory_object->add_plugin( $otw_tsw_plugin_id, dirname( dirname( __FILE__ ) ).'/otw_content_manager.php', array( 'menu_parent' => 'otw-tsw-settings', 'lc_name' => __( 'License Manager', 'otw_tsw' ), 'menu_key' => 'otw-tsw' ) );
